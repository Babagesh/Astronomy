# Web Development Project 4 - *NASA APOD App*

Submitted by: **Bhagyesh Jethwani**

This web app: **Displays Astronomy Images**
...
Had a challenge with my original API which gave me CORS error. Had to switch to a public API. 
